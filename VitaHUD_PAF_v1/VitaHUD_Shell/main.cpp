...
extern "C" int module_start(SceSize args, const void *argp)
{
    ...
    /*
     * In a real shell/PAF plugin, g_corePlugin must be resolved from the shell/plugin context.
     * This skeleton keeps the architecture separated so the next step can wire it to the
     * actual core plugin initialization path.
     */
