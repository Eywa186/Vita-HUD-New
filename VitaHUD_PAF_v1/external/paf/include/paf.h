...
/*
 * VitaHUD staged PAF bridge header
 * --------------------------------
 * Path:
 *   external/paf/include/paf.h
 *
 * This file is a temporary bridge so:
 *
 *   -DVITAHUD_USE_REAL_PAF=ON
 *   -DVITAHUD_PAF_INCLUDE_DIR=../external/paf/include
 *
 * can compile in GitHub Actions while we locate/wire the real PAF SDK headers.
 *
 * IMPORTANT:
 * This is not a real Sony/PAF implementation.
 * It only mirrors the tiny API surface VitaHUD currently uses.
 *
 * Replace this file with real PAF headers later.
 */
